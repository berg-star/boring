"use strict";
const gamePages = ["reaction.html", "wheel.html", "card.html", "question.html", "fun.html"];
...
if (document.modelContext?.registerTool) {
  ...
  try {
    Promise.resolve(document.modelContext.registerTool({
      ...
      inputSchema: {type:"object", properties:{game:{type:"string",enum:["reaction","wheel","card","question","fun"]}}, required:["game"], additionalProperties:false},
